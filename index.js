...
startWith('QmPs7AftBvGXhpHWqjuT75ay311C2uf7aMCAhahoaDp7k7') //for testing and replaying
                    ...
                    store.del([], function(e) {
                        if (!e) {
                            if (hash) {
                                ...
                                cleanState.balances[`kiokizz`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`edicted`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`erikah`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`urun`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`fronttowardenemy`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`ganjafarmer`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`hivetrending`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`squits`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`meanbees`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`buckydurddle`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`mes`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`antisocialist`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`galberto`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`taskmaster4450le`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`lalupita`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`riandeuk`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`ammonite`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`failingforwards`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`preparedwombat`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`bluerobo`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`appalachain`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`bil.prag`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`amr008.leo`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`klye`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`definethedollar`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`tamaralovelace`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`pfunk`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`tfranzini`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`kenny-crane`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`mba2020`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`dagger212`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`sanjeevm`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`no-advice`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`jfang003`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`revisesociology`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`blezyn`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`borislavzlatanov`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`meesterboom`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`scooter77`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`bozz`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`anarcist69`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`mattclarke`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`arcange`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`lebah`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`masterthematrix`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`ericburgoyne`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`breezin`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`grey580`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`droida`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`javiersebastian`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`crrdlx`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`torrey.blog`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`thebeardflex`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`shortsegments`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`iikrypticsii`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`khan.dayyanz`] += 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`bagofincome`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`clayboyn`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`hykss`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`yeckingo1`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`autobodhi`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`trumpman`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`notak`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`chuckrick`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`anaclark`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`kendewitt`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`minimining`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`hivebeliever`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`tobetada`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`miniature-tiger`] = 5000;
                                cleanState.balances.rm -= 5000;
                                cleanState.balances[`d-zero`] = 5000;
                                cleanState.balances.rm -= 5000;
